...
;; restart emacs
;;
;; Provides a way to quit or restart emacs, all from C-x C-c
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (restart-emacs helm-rg ace-window helm helm-bibtex org org-bullets org-journal org-plus-contrib pdf-tools which-key use-package challenger-deep-theme rainbow-delimiters))))
(custom-set-faces
